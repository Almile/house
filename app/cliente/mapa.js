...
import {Alert,Button,Dimensions,Image,Pressable,StyleSheet,Text,View} from 'react-native';
...
const [visitados, setVisitados] = useState([]);
  ...
  async function obterLocalizacao() {
    ...
    if (!granted) {
      Alert.alert(
        'Permissão negada',
        'Sem localização, o mapa fica tão perdido quanto muita gente procurando imóvel.'
      );
      return;
    }
